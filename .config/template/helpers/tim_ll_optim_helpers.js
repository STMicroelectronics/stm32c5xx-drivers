...
const LL_TIM_functionsCommon = {
  ...
  LL_TIM_OC_ConfigOutput: ["LL_TIM_OCPOLARITY_HIGH | LL_TIM_OCIDLESTATE_RESET"],
  ...
  LL_TIM_SetBreakInputSourcePolarity: [["LL_TIM_TIM\d+_BRK_[A-Z0-9]+", "LL_TIM_TIM\d+_BRK2_[A-Z0-9]+"], "LL_TIM_BREAK_INPUT_SRC_NONINVERTED"],
